...
* Run `./run.miner.sh` and mining begins! Go to url https://luckpool.net/verus/miner.html?RX5n2uXKnZw3Y5kziJZzzk7DvwHqN6hshv to check your mining progress. (Take a couple minutes to show up in the website)
